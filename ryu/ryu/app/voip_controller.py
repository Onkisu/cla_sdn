...
class SimpleSwitch13STP(simple_switch_13.SimpleSwitch13):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Konfigurasi STP (Opsional, agar convergence lebih cepat)
    ...
    def _packet_in_handler(self, ev):
        ...
        # Logging packet (optional, bikin rame terminal controller)
    ...
    def _topology_change_handler(self, ev):
        ...
        msg = '*** STP State Changed: port %s of dpid %s is now %s' % \
              (ev.port_no, dpid_str, ev.port_state)
