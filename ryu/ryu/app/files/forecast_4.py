...
MODEL_PATH             = "/home/takemi/cla_sdn/cla_sdn/ryu/ryu/app/files/xgb_forecast_model.json"   # existing trained model path
...
# ==============================================================================
# LOAD EXISTING MODEL — FOR SIDANG DEMO
# ==============================================================================
def load_existing_model():
    ...
    try:
        # Support XGBoost native model format (.json / .ubj)
        if MODEL_PATH.endswith((".json", ".ubj")):
            model = xgb.XGBRegressor()
            model.load_model(MODEL_PATH)
        else:
            # Support common .pkl model files
            try:
                import joblib
...
if __name__ == "__main__":
    ...
    # Load existing trained model only
    load_existing_model()
